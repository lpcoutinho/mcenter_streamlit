...
# # Dividindo a string nos hífens
# # ano, mes, dia = map(int, date_from_str.split('-'))
# ano_from, mes_from, dia_from = date_from.year, date_from.month, date_from.day
# ano_to, mes_to, dia_to = date_to.year, date_to.month, date_to.day

# print(ano_from)
# print(type(ano_from))

# date_from = datetime(ano_from, mes_from, dia_from).date()
# date_to = datetime(ano_to, mes_to, dia_to).date()

# # Defina as datas de início e fim desejadas
# date_to = datetime(2023, 11, 15).date()
# date_from = datetime(2023, 11, 23).date()
